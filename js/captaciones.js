...
for (let i = 1; i <= count; i++) {
  ...
  div.innerHTML = `
    ...
    <div class="checkbox-group">
      <label for="cama_cu${i}">
      <input type="checkbox" id="cama_cu${i}" name="camas">
        Camas
      </label>
      <label for="colchon_cu${i}">
        <input type="checkbox" id="colchon_cu${i}" name="colchon">
        Colchón
      </label>
      <label for="peinadora_cu${i}">
        <input type="checkbox" id="peinadora_cu${i}" name="peinadora">
        Peinadora
      </label>
      <label for="vestier_cu${i}">
        <input type="checkbox" id="vestier_cu${i}" name="vestier">
        Vestier
      </label>
      <label for="aire_cu${i}">
        <input type="checkbox" id="aire_cu${i}" name="a-a">
        A/A
      </label>
      <label for="tv_cu${i}">
        <input type="checkbox" id="tv_cu${i}" name="televisor">
        Televisor
      </label>
      <label for="mesa_noche_cu${i}">
        <input type="checkbox" id="mesa_noche_cu${i}" name="mesa-noche">
        Mesa de noche
      </label>
      <label for="poltrona_cu${i}">
        <input type="checkbox" id="poltrona_cu${i}" name="poltrona">
        Poltrona
      </label>
      <label for="directv_cu${i}">
        <input type="checkbox" id="directv_cu${i}" name="directv">
        Directv
      </label>
      <label for="closet_cu${i}">
        <input type="checkbox" id="closet_cu${i}" name="closet">
        Closet
      </label>
      <label for="lamparas_cu${i}">
        <input type="checkbox" id="lamparas_cu${i}" name="lamparas">
        Lámparas
      </label>
      <label for="espejo_cu${i}">
        <input type="checkbox" id="espejo_cu${i}" name="espejo">
        Espejo
      </label>
      <label for="perchero">
        <input type="checkbox" id="perchero" name="perchero">
        Perchero
      </label>
    </div>
  `;
